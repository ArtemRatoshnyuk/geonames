...
def exstraction_admin1CodesASCII():
...
def learn_corp():
    ...
    df_altern_all = exstraction_altern_all()
    # Обучающий корпус
...
def answ_predict(text, num=1):
    
    vectorizer_en = vector_en()[0]
    bow_en = vector_en()[1]
